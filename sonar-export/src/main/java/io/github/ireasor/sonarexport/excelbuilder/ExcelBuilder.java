...
public class ExcelBuilder {
	...
	public void addSheet(String project, List<Issue> searchResults) {
		HSSFSheet sheet = workbook.createSheet(project.replaceAll(":", " "));
		populateSheet(sheet, searchResults);
	}
	...
	private void populateSheet(HSSFSheet sheet, List<Issue> searchResults) {
